...
| [PixelAPI](https://pixelapi.dev) | [Docs](https://pixelapi.dev/docs.html) | Y | Pay-per-use AI image API: background removal, product photography, FLUX/SDXL generation, 4x upscaling, virtual try-on, object removal, image captioning, AI shadows. Runs on owned GPUs — from $0.001/image, 5-10x cheaper than Replicate. Python + JS SDKs. |
...
- [GEOmind](https://geomind.app) - Track your brand citations in ChatGPT, Perplexity, Google AI Overviews, Claude, and Bing AI. Generative Engine Optimization (GEO) platform for AI search visibility. From ₹999/month with 30-day money-back guarantee.
